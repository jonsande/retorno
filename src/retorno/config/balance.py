...
class Balance:
    ...
    HIBERNATE_SEQUENCE_LINE_DELAY_S = 0.85
    HIBERNATE_SEQUENCE_TYPEWRITER = False
    HIBERNATE_SEQUENCE_TYPEWRITER_CPS = 195
    HIBERNATE_SEQUENCE_COUNTDOWN_S = 10
    HIBERNATE_WAKE_PANEL_BLACKOUT_S = 2.0
    HIBERNATE_WAKE_SEQUENCE_LINE_DELAY_S = 0.85
    HIBERNATE_WAKE_SEQUENCE_TYPEWRITER = False
    HIBERNATE_WAKE_SEQUENCE_TYPEWRITER_CPS = 195
